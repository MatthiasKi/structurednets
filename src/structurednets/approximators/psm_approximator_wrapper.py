...
class PSMApproximatorWrapper(Approximator):
    ...
    def approximate(self, optim_mat: np.ndarray, nb_params_share: float, num_interpolation_steps=17):
        ...
        for nb_matrices in [2, 3]:
            for linear_nb_nonzero_elements_distribution in [True, False]:
                ...
                res_dict = approximator.approximate(optim_mat=optim_mat, nb_params_share=nb_params_share, num_interpolation_steps=num_interpolation_steps)
